...
If so, these poorly organized notes may be helpful to you. You may also find [[https://www.youtube.com/watch?v=yiTagAkf4X4][this presentation]] I co-delivered with Andrew Morgan from [[https://sixta.ai][Sixta]] interesting.
...
A bot that can link those requests and even get Alice and Bob connected will be more useful that one that can't.
